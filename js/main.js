...
function initScrollAnimations() {
    ...
    var revealConfigs = [
        ...
        { selector: '.article-toc', y: 20 },
        { selector: '.article-content h2', stagger: 0, y: 30 },
        { selector: '.author-box', y: 30 },
        { selector: '.related-card', stagger: 0.1, y: 30 },
        { selector: '.article-nav-link', stagger: 0.15, y: 20 },
        { selector: '.blog-section .blog-card', stagger: 0.1, y: 40 },
        { selector: '.share-bar .share-btn', stagger: 0.1, y: 20 }
    ];
...
(function initShareButtons() {
    ...
    bar.setAttribute('aria-label', 'Compartir artículo');
